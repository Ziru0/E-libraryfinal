...
<h1>Reservations</h1>
			...
			if ($result->num_rows > 0) {
				...
				while($row = $result->fetch_assoc()) {
					...
					<td>" . $row["course"] . "</td>
					<td>" . $row["dates"] . "</td>
					<td> <a class='btn btn error' href='delete.php?delete=" . $row['reservation_id'] . "'>Pending</a> </td>
					</tr>";
				}
				echo "</table>";
			} else {
...
<tbody>
	...
	<tr class="record">
        ...
        <td><a class='btn btn-error' href='delete.php?delete1=<?php echo $row['book_id']; ?>'>delete</a></td>
	</tr>
	<?php
		}
	?>
...
<form action="" method="POST">  
    ...
    <button class="btn btn error" type="submit" value="submit" name="addp">add book</button>

    <?php
	include 'connn.php';
if (isset($_POST['addp'])) {
	$stmt = $connection->prepare("INSERT INTO booklist (title, author, about) VALUES (?, ?, ?)");
